...
public class Application implements EntryPoint {
	...
	public void onModuleLoad() {
		...
		new RetrieveServer((UMLGraphServiceAsync) GWT
				.create(UMLGraphService.class));
		Log.debug("get modsl.uml");
		RootPanel params = RootPanel.get("modsl.uml");
		if (params != null) {
			String value = DOM.getInnerText(params.getElement());
			
			GraphEventBus.get().fireEvent(new GraphEvent(origin,value, GraphEventType.CONTENT_CHANGED));
		}
	}
